    ...
    <form action="{{ route('vacantes.update', ['vacante' => $vacante->id]) }}" method="POST" class="max-w-lg mx-auto my-10">
        ...
        <div class="mb-5">
            ...
            <input type="text" name="titulo" class="p-2 bg-white rounded form-input w-full" id="titulo"
                placeholder="Web developer" value="{{ $vacante->titulo }}">
            ...
            <select name="experiencia" id="experiencia"
                ...
                @foreach ($experiencias as $experiencia)
                    <option {{ $vacante->experiencia_id == $experiencia->id ? 'selected' : '' }}
                        value="{{ $experiencia->id }}" class="text-sm text-gray-500">
                        {{ $experiencia->nombre }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="mb-5">
            ...
            <lista-skills :lista-skills="{{ $skills }}" old-fields="{{ $vacante->skills }}"></lista-skills>

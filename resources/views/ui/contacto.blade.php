    ...
    <form action="{{ route('candidatos.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nombre"
                ...
                id="nombre" placeholder="Your name" value="{{ old('nombre') }}">
        ...
        <div class="mb-4">
            ...
            <input type="file" name="cv"
                class="p-3 bg-gray-100 rounded form-input w-full overflow-hidden @error('cv') border border-red-500 @enderror"
        ...
        {{-- para enviar el id de la vacante --}}

...
@section('content')
    <div class="container mx-auto max-w-screen-md">
        <div class="flex flex-wrap justify-center">
            <div class="md:w-1/2 order-2 md:order-1">
                <div class="w-full max-w-sm">
                    <div class="flex flex-col break-words bg-white border-2 shadow-md mt-12">
                        ...
                        <form method="POST" action="{{ route('register') }}" class="py-5 mx-5" novalidate>
                            @csrf
            ...
            <div class="md:w-1/2 order-1 md:order-2 text-center flex flex-col justify-center mt-10">
                <h1 class="text-teal-500 text-3xl">¿Eres Reclutador?</h1>
                <p class="text-xt mt-5 leading-7">Crea una cuenta totalmente gratis y comienza a publicar hasta 10 vacantes
                </p>
            </div>
        </div>
    </div>
